...
def isu_file():
    file_output(f'{drive_letter}:/pythonProject_Tests/University_progs/20150_members.txt')
    ...
    with open(f'{drive_letter}:/pythonProject_Tests/University_progs/20150_members.txt', file_mode, encoding='UTF-8') as file:
        if file_mode == 'w':
